...
# when downloading the data, the folders are named with the following format:
folders = [
...
# because of this, we want to combine the data into one folder
# and rename the files to be consistent

combined_path = os.path.join(base_path, "combined_training_data_vestland")
    ...
    for folder in folders:
        ...
        with open(csv_file_path, mode='r', encoding='utf-8') as csv_file:
            ...
            for row in reader:
                ...
                new_audio_path = f"../training_data/combined_training_data_vestland/sound_clips/{file_name}"
